...
import com.entertainment.nifi.processor.util.FileInfo;
import com.entertainment.nifi.processor.util.FileTransfer;
                    ...
                    session.read(flowFile, new InputStreamCallback() {
                        ...
                        public void process(final InputStream in) throws IOException {
                            try (final InputStream bufferedIn = new BufferedInputStream(in)) {
                                if (workingDirPath != null && context.getProperty(ConfigurableSFTPTransfer.CREATE_DIRECTORY).asBoolean()) {
